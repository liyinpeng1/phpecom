    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                ?>
                <div class="card">
                    <div class="card-header" style="background-color:#ff914d">
                    ...
                    <div class="card-body">
                        <form action="functions/authcode.php" method="POST">
                            ...
                            <button type="submit" name="register_btn" class="btn " style="background-color:#ff914d; color:white">Submit</button>
                        </form>
                    </div>
                </div>
