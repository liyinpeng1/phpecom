...
if(isset($_SESSION['auth']))
{
    ...
    if(isset($_POST['placeOrderBtn']))
    {
        ...
        $insert_query = "INSERT INTO orders (tracking_no, user_id,	name, email, phone, address, zipcode, total_price, payment_mode, payment_id ) VALUES ('$tracking_no', '$userId', '$name', '$email', '$phone', '$address', '$zipcode', '$totalPrice', '$payment_mode', '$payment_id') ";
